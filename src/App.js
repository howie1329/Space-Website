            ...
            <Route path="/destination" element={<Destination />}>
              <Route
                ...
                element={
                  <DestinationCard
                    name={moon_data.name}
                    body_text={moon_data.description}
                    image={moon_image}
                    distance={moon_data.distance}
                    travel_time={moon_data.travel}
                  />
                }
              />
              <Route
                ...
                element={
                  <DestinationCard
                    name={mars_data.name}
                    body_text={mars_data.description}
                    image={mars_image}
                    distance={mars_data.distance}
                    travel_time={mars_data.travel}
                  />
                }
              />
              <Route
                ...
                element={
                  <DestinationCard
                    ...
                    body_text={europa_data.description}
                    image={europa_image}
                    distance={europa_data.distance}
                    travel_time={europa_data.travel}
                  />
                }
              />
              <Route
                ...
                element={
                  <DestinationCard
                    ...
                    body_text={titan_data.description}
                    image={titan_image}
                    distance={titan_data.distance}
                    travel_time={titan_data.travel}
                  />
                }
              />
            </Route>
